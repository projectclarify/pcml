...
class ModelTest(parameterized.TestCase):
  ...
  def test_embedder_returns_correct_output_shape(self):
    ...
    vocab_size = 5
    embedding_size = 3
    model = models.Embedder(vocab_size=vocab_size,
  ...
  def test_lstm_returns_correct_output_shape(self):
    ...
    initial_state = models.SimpleLSTM.initialize_carry((batch_size,),
                                                       hidden_size)
  ...
  def test_text_classifier_returns_correct_output_shape(self):
    ...
    model = models.TextClassifier(embedding_size=embedding_size,
