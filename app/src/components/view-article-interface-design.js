...
let ViewArticleInterfaceDesign = class ViewArticleInterfaceDesign extends connect(store)(PageViewElement) {
    static get styles() {
        return [
            SharedStyles,
            css `
...
ViewArticleInterfaceDesign = __decorate([
    customElement('view-article-interface-design')
], ViewArticleInterfaceDesign);
export { ViewArticleInterfaceDesign };
